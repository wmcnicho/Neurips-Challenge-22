...
def main():
    ...
    dataset_tensor = torch.load('serialized_torch/compressed_training_data_tensor.pt')
    with open("serialized_torch/compressed_training_data_construct_list.json", 'rb') as fp:
